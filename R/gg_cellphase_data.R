...
#'
#' @usage gg_cellphase_data(dm.gpf, resolution = dendro.resolution(dm.gpf),shapeSensitivity = 0.6, minmaxDist = 0.2,minmaxSD = 2, radialIncrease = "max", na.omit = TRUE)
#'
...
#'}
#'
#' @export gg_cellphase_data
#'


gg_cellphase_data <- function(dm.gpf, resolution = dendro.resolution(dm.gpf),
